...
const CardProyectItem = ({
  ...
  return (
    <div className="flex flex-col ">
      <a
        href={link}
        className="flex flex-col md:flex-row cursor-pointer justify-center  w-[70%] max-w-[600px] m-auto mt-10 items-center rounded-tr-md  bg-[#222]"
      >
        ...
        <div className="flex flex-col w-[60%] gap-2 mx-2 ml-3">
          <div>
            <h1 className="text-3xl font-semibold text-center md:text-left mt-2 md:m-0 text-[#E7CFFF] hover:underline underline-offset-8">
              {name}
            </h1>
          </div>
          <div>
