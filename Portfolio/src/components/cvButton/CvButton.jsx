  ...
  return (
    <div className="flex justify-center my-32 ">
      ...
      >
        ...
        <div className="relative flex gap-1 items-center text-purple-700  bg-gray-100 border border-gray-500 rounded-lg py-2 px-4 transition transform hover:translate-y-[1px]  active:translate-y-[7px]">
          <div>
