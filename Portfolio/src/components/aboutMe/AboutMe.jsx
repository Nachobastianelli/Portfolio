...
const AboutMe = () => {
  ...
  return (
    ...
    >
      <h1 className="flex  items-center justify-start text-3xl font-semibold text-[#bfedff] cursor-pointer  hover:underline underline-offset-8 mt-8 max-w-[82%] mx-auto">
        <a href="#about-me">{t("description")} 🧑🏽‍🎓</a>
      </h1>
